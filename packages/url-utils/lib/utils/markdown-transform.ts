...
interface TransformFunctions {
    ...
    url: (url: string, siteUrl: string, itemPath: string | null, options: MarkdownTransformOptions) => string;
}
...
function markdownTransform(markdown = '', siteUrl: string, transformFunctions: TransformFunctions, itemPath: string | null, _options: MarkdownTransformOptions = {}): string {
