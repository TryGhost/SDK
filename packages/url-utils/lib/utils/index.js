module.exports = {
    ...
    mobiledocTransformTreadyToAbsolute: require('./mobiledoc-transform-ready-to-absolute'),
    mobiledocTransformTreadyToRelative: require('./mobiledoc-transform-ready-to-relative'),
