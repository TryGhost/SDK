...
type TransformFunction = (url: string, siteUrl: string, itemPath: string | null, options: MobiledocTransformOptions) => string;

function mobiledocTransform(serializedMobiledoc: string, siteUrl: string, transformFunction: TransformFunction, itemPath: string | null, _options: MobiledocTransformOptions = {}): string {
    const defaultOptions: MobiledocTransformOptions = {assetsOnly: false, secure: false, cardTransformers: []};
