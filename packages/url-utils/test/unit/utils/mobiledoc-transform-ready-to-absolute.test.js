...
const mobiledocTransformReadyToAbsolute = require('../../../lib/utils/mobiledoc-transform-ready-to-absolute');

describe('utils: mobiledocTransformReadyToAbsolute()', function () {
    ...
    it('converts transform-ready URLs in markups', function () {
        ...
        const serializedResult = mobiledocTransformReadyToAbsolute(serializedMobiledoc, siteUrl, options);
    ...
    it('converts transform-ready URLs in markups with subdir site url', function () {
        ...
        const serializedResult = mobiledocTransformReadyToAbsolute(serializedMobiledoc, 'https://example.com/blog/', options);
        const result = JSON.parse(serializedResult);
    ...
    it('converts transform-ready URLs in card payloads', function () {
        ...
        const serializedResult = mobiledocTransformReadyToAbsolute(serializedMobiledoc, siteUrl);
        const result = JSON.parse(serializedResult);
