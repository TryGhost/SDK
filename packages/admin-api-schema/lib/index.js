 ...
 * @param {'v2'|'canary'} - API's JSON schema version to check against
 ...
 * @property {'v2'|'canary'} options.version - API version to data belongs to, e.g.: 'v2', 'canary'
...
/**
 *
 * @param {'v2'|'v3'|'canary'} - version to resolve into internaly available version
 *
 * @returns {'v2'|'canary'} - resolved version
 */
